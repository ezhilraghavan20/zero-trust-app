...
export class PostureService {
    ...
    public async evaluatePosture(input: IDeviceInput): Promise<IDevicePosture> {
        ...
        const evaluation = this.evaluator.evaluate({
            os: { isHealthy: osSignals.isUpToDate, isSupported: osSignals.isSupported },
            security: {
                isHealthy: securitySignals.isFirewallActive && securitySignals.isEncrypted,
                isAvRunning: securitySignals.isAvRunning
            },
